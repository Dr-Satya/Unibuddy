  ...
  return isModal ? (
    ...
    <div className="min-h-screen bg-[#080c14] text-slate-100 flex items-center justify-center">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.5 }}
        className='max-w-2xl w-full bg-slate-900/95 backdrop-filter backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-800 overflow-hidden relative z-10 mx-4'
      >
        {/* Close Button - Only show in modal mode */}
        {isModal && (
          <button
